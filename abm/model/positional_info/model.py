...
class Model(AgentEnoder):
    ...
    def init_response_field(self):
        ...
        pts = self.P[:,:].tolist()
        kernel = signals.gaussian_kernel(10,3) ## These needs to be defined externally
        Pf = np.zeros((self.num_rows,self.num_cols,self.num_agents))
